...
const CREDENTIAL_RULES = [
  ...
  // Test keys are still secrets, and an app shipped with one is an app whose
  // author believed a secret key belonged in client-side code. Same block: the
  // habit is the problem, not which environment it points at.
  { rule: "stripe-test-key", label: "Stripe secret key (test mode)", re: /\b(?:sk|rk)_test_[a-zA-Z0-9]{20,}/g },
...
const CODE_RULES = [
  ...
  },
  {
    ...
    remediation: "Remove this. These keys belong to VibeSafe Builder itself, not to your app, and reading them exposes other people's credentials.",
  },
  {
